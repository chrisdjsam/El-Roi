El-Roi Face Recognition
================

| Recognize and manipulate faces from webcam or camera
| 
...
- Add Members and capture sample data
- Train the system to learn the new dataset
- Mark an attendance when the face is detected.
