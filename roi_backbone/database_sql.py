...
class SQLDatabase(Database):
    ...
    CREATE_MEMBERS_TABLE = """
        ...
        member_lastname varchar(35), member_email varchar(100), member_phone varchar(15), member_created DATETIME DEFAULT CURRENT_TIMESTAMP, 
    ...
    INSERT_MEMEBER = """ INSERT INTO %s(%s,  %s, %s, %s, %s) VALUES(%%s, %%s, %%s, %%s, %%s); 
    """ % (MEMBERS_TABLENAME, Database.FIELD_MEMBER_FIRST_NAME, Database.FIELD_MEMBER_LAST_NAME, Database.FIELD_MEMEBER_EMAIL, Database.FIELD_MEMEBER_PHONE, Database.FIELD_MEMBER_PERSON_ID)
    ...
    """ % (MEMBERS_FACE_TABLENAME, Database.FIELD_MEMBER_PERSON_ID)

    SELECT_EXISTING_ATTENDANCE = """ SELECT * FROM %s WHERE %s = %%s and datetime(timestamp, 'localtime') > datetime('now', '-1 days', 'localtime') 
